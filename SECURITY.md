...
```
https://github.com/OpenSecOps-Org/SOAR-SAM-Automating-Forensic-Disk-Collection/releases/download/<VERSION>/SOAR-SAM-Automating-Forensic-Disk-Collection-<VERSION>-sbom.cdx.json
```
...
Together they are the authoritative cross-component references; the per-component sections above describe how the project-wide posture applies to **SOAR-SAM-Automating-Forensic-Disk-Collection** specifically.
