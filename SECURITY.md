...
That document is the authoritative cross-component reference; the per-component sections above describe how the project-wide posture applies to **SOAR-SAM-Automating-Forensic-Disk-Collection** specifically.
